...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(cdlatex monokai-theme jdee solarized-theme ox-hugo org-mobile-sync all-the-icons wc-mode)
