...
layers configuration. You are free to put any user code."
  ...
  ;; (setq cfs-profiles '("orging" "reading"))
...
(custom-set-faces
 ...
 '(org-level-1 ((t (:inherit fixed-pitch :foreground "#cb4b16" :height 1.0 :family "Consolas"))))
 '(org-level-2 ((t (:inherit fixed-pitch :foreground "#859900" :height 1.0 :family "Consolas"))))
