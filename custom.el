...
(custom-set-faces
 ...
 '(markdown-inline-code-face ((t (:inherit font-lock-constant-face :weight normal :height 1.0 :width normal))))
 '(org-archived ((t (:foreground "slate gray" :weight normal :height 1.0 :width normal :family "consolas"))))
 '(org-special-keyword ((t (:foreground "dark turquoise" :weight bold :height 1.0 :width normal :family "consolas"))))
 '(region ((t (:inherit highlight :background "light sky blue" :foreground "black")))))
